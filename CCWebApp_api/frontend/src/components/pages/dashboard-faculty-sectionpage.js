...
import { setsidebarState, setsubsidebarState, setpageHeader, getSectiondata} from '../../redux/actions/main';
...
function AdvisoryPage(props) {
    ...
    useEffect(() => {
        try{
            ...
            setStudents(props.sectionData.students)
        }catch(error){}
      }, [props.sectionData]);
            ...
            <InputGroup>
              ...
              <div style={{display: 'flex', justifyContent: 'space-between', width: '100%', gap: '8px'}}>
                <div className="form-group text-left"style={{width: '50%'}}>
                    ...
                    {props.sectionData.track !== "NONE" || !strand &&
                        <div className="form-group text-left"style={{width: '50%'}}>
                            <Form.Group>
...
export default withAuth(connect(mapStateToProps, {setsidebarState, setsubsidebarState, setpageHeader, getSectiondata})(AdvisoryPage))