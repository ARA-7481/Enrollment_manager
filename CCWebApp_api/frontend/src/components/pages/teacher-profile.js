      ...
      <div style={{backgroundColor:'#ffffff', borderRadius:'8px', padding: '24px'}}>
        <div style={{backgroundColor:'#ffffff', height: '124px', borderRadius:'8px', display: 'flex', alignItems: 'center', paddingRight: '24px', paddingTop: '24px', marginBottom: '48px'}}>
            ...
            <div>
                ...
                <h1 className='inter-500-16px-dark'>{props.teacherData.length != 0 && props.teacherData[0].position }</h1>
                <div style={{display: 'flex'}}>
                    {props.teacherData.length != 0 && props.teacherData[0].courses.map(course => (<h1 className='inter-400-16px' style={{marginRight: '8px'}} key={course}>{course}</h1>)) }
                </div>
            </div>
        </div>
            <div style={{borderBottom: '1px solid gray', borderTop: '1px solid gray', paddingBottom: '24px', paddingTop: '24px'}}>
                ...
                <div className="form-group text-left"style={{width: '70%', marginRight: '8px'}}>
                    <Form.Group>
                        ...
                        <div style={{display: 'flex'}}>
                            <h1 className='inter-500-16px-dark'>{props.teacherData.length != 0 && props.teacherData[0].id}</h1>
                        </div>
                    </Form.Group>
                </div>
                <div className="form-group text-left"style={{width: '70%', marginRight: '8px'}}>
...
export default withAuth(connect(mapStateToProps, {setsidebarState, setsubsidebarState, setpageHeader, setUseravatar, setUseremail, setPassword})(TeacherProfile))