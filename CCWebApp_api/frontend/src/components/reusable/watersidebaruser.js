      ...
      <CDBSidebar toggled={isToggled} breakpoint={200} textColor='#8A92A6' backgroundColor="#fff" collapsed={isCollapsed} maxWidth={isCollapsed ? '92px' : '257px'} minWidth='92px' style={{fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 500, fontSize: '16px'}}>
        ...
        <CDBSidebarHeader prefix={
          <div style={{display: 'flex'}}>
            ...
            {isCollapsed && 
             <Nav.Link href="" onClick={handleCollapse}>
              <ColoredHat />
            </Nav.Link>
            }
            </div>
        ...
        >
            ...
            <Nav.Link href="/#/admins/users-students" style={{transform: 'translate( 0px, -12px)'}}>
              ...
              <h1 className='inter-500-16px-dark' style={{ marginTop: '8px'}}>BISU IoT MANAGEMENT</h1>
            </Nav.Link>
            }
        </CDBSidebarHeader>
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu style={{  display:'flex', justifyContent: 'start', paddingLeft:'24px'}}>
            ...
            <Nav.Link href="/#/water/dashboard" style={{paddingBottom: '8px'}}>
            ...
            <Nav.Link href="/#/water/billing" style={{paddingBottom: '8px'}}>
            <div title={isCollapsed ? 'Billing':''} className='zooming-icon' style={{color: props.sidebarState === 'class' ? 'white' : '', backgroundColor: props.sidebarState === 'class' ? '#3A57E8' : '' ,display:'flex', justifyContent: isCollapsed ? 'center':'start', alignItems: 'center', width: isCollapsed ? '45px' : '210px', height:'44px', borderRadius:'4px'}}>
            <div style={{marginLeft: isCollapsed ? '20px':'10px'}}>
            <ConnectedClassIcon/>
            </div>
            <div style={{paddingLeft: '20px'}}>
            ...
            <Nav.Link href="/#/water/profile" style={{paddingBottom: '8px'}}>
...
export default connect(mapStateToProps, {setsidebarState, setsubsidebarState})(Watersidebar);