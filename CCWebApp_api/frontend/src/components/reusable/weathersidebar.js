...
function Weathersidebar(props){
 ...
 useEffect(() => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'scroll initial', backgroundColor:'rgba(51, 51, 51, 0.00)'}}>

      <CDBSidebar toggled={isToggled} breakpoint={200} textColor='#8A92A6' backgroundColor='rgba(51, 51, 51, 0.40)' collapsed={isCollapsed} maxWidth={isCollapsed ? '92px' : '257px'} minWidth='92px' style={{fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 500, fontSize: '16px'}}>
        ...
        <CDBSidebarHeader prefix={
          ...
          <Card onClick={handleCollapse} style={{backgroundColor:'rgba(51, 51, 51, 0.00)', transform: !isCollapsed? 'translate(25px, 6px)' : 'translate(73px, 6px)', position:'fixed', width:'10px'}}>
          {!isCollapsed && 
              <ToogleIcon />
            }
            {isCollapsed && 
        ...
        >
            ...
            <Nav.Link href="/#/admins/users-students" style={{transform: 'translate( 0px, -12px)'}}>
              ...
              <h1 style={{ marginTop: '8px', fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 400, fontSize: '15px', color: 'black'}}>RAINFALL & WATERLEVEL</h1>
              <h1 style={{ marginTop: '2px', fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 400, fontSize: '15px', color: 'black', marginLeft: '8px'}}>MONITORING SYSTEM</h1>
            </Nav.Link>
            }
        </CDBSidebarHeader>
