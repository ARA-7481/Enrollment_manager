                ...
                <div className="form-group text-left"style={{width: '70%', marginRight: '8px'}}>
                    <Form.Group>
                        ...
                        <div style={{display: 'flex'}}>
                            <h1 className='inter-500-16px-dark'>{user.id}</h1>
                        </div>
                    </Form.Group>
                </div>
                <div className="form-group text-left"style={{width: '70%', marginRight: '8px'}}>
...
export default withAuth(connect(mapStateToProps, {setsidebarState, setsubsidebarState, setpageHeader, setUseravatar, setUseremail, setPassword})(WaterProfile))