...
function Studentdashboard(props) {
  ...
  useEffect(() => {
    ...
    if(!props.isLess800){
        ...
        props.setpageHeader(`Hello ${user.first_name}`, '', '');
        }
           ...
           :
            ...
            <div style={{backgroundColor:'#e9ecef', borderTopLeftRadius:'8px', borderTopRightRadius:'8px', width: '100%'}}> 
                <div style={{backgroundColor:'#ffffff', height: '124px', borderRadius:'8px', display: 'flex', alignItems: 'center', padding: '24px'}}>
                    ...
                    <div style={{marginLeft: '24px'}}>
                        <div style={{display: 'flex'}}>
                        <h1 className='inter-400-16px-dark'>{user.first_name} {user.last_name}</h1>
                        <div style={{marginLeft: '8px', marginTop: '3px'}}>
                        </div>
                        </div>
                        {props.studentData.id && (() => {
                        ...
                        <h1 className='inter-400-12px-dark' style={{marginRight: '8px', marginTop: '8px'}}>{props.studentData.id}</h1>

                        <div style={{display: 'flex'}}>
                            {props.studentData.id && <h1 className='inter-400-10px-dark' style={{marginRight: '8px'}}>{props.studentData.gradelevel} </h1> }
                            {props.studentData.strand && <h1 className='inter-400-10px-dark' style={{marginRight: '8px'}}> - {props.studentData.strand}</h1> }
                            {props.studentData.track && <h1 className='inter-400-10px-dark' style={{marginRight: '8px'}}> - {props.studentData.track}</h1> }
                ...
                <Accordion.Header >
                    ...
                    <Accordion.Body style={{overflow: 'auto'}}>
                        ...
                        <thead>
                            <tr>
                            <th className='table-head ' style={{width: '30%', paddingLeft:'20px'}}> <h1 className='inter-400-10px-dark'>SUBJECT</h1></th>
                            <th className='table-head' style={{width: '20%'}}><h1 className='inter-400-10px-dark'>TEACHER</h1></th>
                            <th className='table-head' style={{width: '8%'}}><h1 className='inter-400-10px-dark'>Q1</h1></th>
                            <th className='table-head' style={{width: '8%'}}><h1 className='inter-400-10px-dark'>Q2</h1></th>
                            <th className='table-head' style={{width: '8%'}}><h1 className='inter-400-10px-dark'>Q3</h1></th>
                            <th className='table-head' style={{width: '8%'}}><h1 className='inter-400-10px-dark'>Q4</h1></th>
                            <th className='table-head' style={{width: '8%'}}><h1 className='inter-400-10px-dark'>AVE</h1></th>
                            <th className='table-head' style={{width: '20%'}}><h1 className='inter-400-10px-dark'>REMARKS</h1></th>
                            </tr>
                            </thead>
                            <tbody>
                            {g7.sort((a, b) => a.in_class.subject.localeCompare(b.in_class.subject))?.map((gradeentity) => (
                                <tr key={gradeentity.id}>
                                    <td className='table-body' style={{ paddingLeft: '20px' }}>
                                    <h1 className='inter-400-10px-dark'>
                                        {gradeentity.in_class.subject}
                                    </h1>
                                    </td>
                                    <td className='table-body'>
                                    ...
                                    <td className='table-body' >
                                        <h1 className='inter-400-10px-dark' style={{color:  gradeentity.remarks==="Ongoing"?'#0047AB':
                                                                                            gradeentity.remarks==="Passed"?'green':
                                                                                            gradeentity.remarks==="Failed"?'red':
                                                                                        'black'}}>
                                            {gradeentity.remarks}
