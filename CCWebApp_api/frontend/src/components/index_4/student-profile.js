...
function StudentProfile(props) {
    ...
    useEffect(() => {
        ...
        if(!props.isLess800){
            props.setpageHeader(`Hello ${user.first_name}`, '', 'Welcome to your Profile');
            }else{
  ...
  return (
      ...
      <div style={{backgroundColor:'#ffffff', borderRadius:'8px', padding: '24px'}}>
        <div style={{backgroundColor:'#ffffff', height: '124px', borderRadius:'8px', display: 'flex', alignItems: 'center', paddingTop: '24px', marginBottom: '48px'}}>
