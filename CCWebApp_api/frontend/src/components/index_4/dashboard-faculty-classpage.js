...
function ClassPage(props) {
    ...
    const MyDocument = () => (
        <Document>
          ...
          <View style={{ padding: '15px', borderTop: '2px solid black', borderBottom: '2px solid black', marginBottom: '12px', flexDirection: 'row', gap: '50px'}}>
          <Image style={{width: 80, height: 80}} src="https://127.0.0.1:8000/media/logo.png" />
            <View style={{alignSelf: 'center'}}>
            <Text style={{alignSelf: 'center', fontSize: '25px', fontWeight: 700}}>CLASS REPORT SHEET</Text>
            <Text style={{alignSelf: 'center', fontSize: '12px', fontWeight: 700}}>Cambagui-Calinginan Norte National High School</Text>
