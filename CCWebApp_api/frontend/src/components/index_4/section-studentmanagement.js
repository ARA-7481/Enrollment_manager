...
import { setsidebarState, setsubsidebarState, setpageHeader, getSectiondata, getStudentdata, setStudentPromotion, setsectionState} from '../../redux/actions/main';
...
export default withAuth(connect(mapStateToProps, {setsidebarState, setsubsidebarState, setpageHeader, getSectiondata, getStudentdata, setStudentPromotion, setsectionState})(SectionPage))