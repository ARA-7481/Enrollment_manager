...
function UsersMasterlist(props) {
  ...
  useEffect(() => {
    ...
    props.setpageHeader('Users Masterlist', '', 'Welcome to the masterlist');
  }, []);
...
export default withAuth(connect(mapStateToProps, {setsidebarState, setsubsidebarState, setpageHeader})(UsersMasterlist))