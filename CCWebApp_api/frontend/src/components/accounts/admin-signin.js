                           ...
                           <Card.Body>
                              ...
                              <Form style={{fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 400, fontSize: 13}}>
                                 <Row>
                                    <Col lg="12">
                                       <Form.Group className="mb-4 form-group">
                                          ...
                                          <Form.Control type="email" className="" id="email" aria-describedby="email"  onChange={e => setEmail(e.target.value)}/>
                                       </Form.Group >
                                    </Col>
                                    <Col lg="12" className="">
                                       <Form.Group className="mb-4 form-group">
                                          <Form.Label htmlFor="password" className="" style={{color:'#8A92A6'}}>Password</Form.Label>
                                          <Form.Control type="password" className="" id="password" aria-describedby="password"  onChange={e => setPassword(e.target.value)}/>
                                       </Form.Group>
                                    </Col>
                                 ...
                                 <div className="d-flex justify-content-center">
                                    <Button onClick={handleSignIn} type="button" variant="btn btn-primary" style={{borderRadius: '4px', backgroundColor: '#3A57E8', paddingLeft: '24px', paddingRight: '24px', paddingBottom: '8px', paddingTop: '8px', width: '188px', height: '44px'}}>Sign In</Button>
                                 </div>
